...
#pragma intvect Ext2IRQHandler    18    /* External Interrupt 2         */
...
#pragma intvect DefaultIRQHandler 32    /* Reload Timer 0               */
...
#pragma intvect USARTRxIRQHandler 68    /* USART (LIN, FIFO) 5 RX       */
